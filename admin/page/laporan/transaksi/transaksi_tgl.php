...
<div class="panel panel-default">
  <div class="panel-heading">
     <h1>Laporan Peminjaman Dalam 30 Hari</h1>
   </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
            ...
            $sql = $conn -> query("SELECT * FROM tb_peminjaman WHERE tgl_pinjam BETWEEN DATE_SUB(NOW(), INTERVAL 30 DAY) AND NOW()");
...
<a target="_blank" href="../laporan_transaksi_tgl.php" class="btn btn-primary" style="margin-bottom: 10px"><i class="material-icons md-18">print</i> Cetak Laporan</a>

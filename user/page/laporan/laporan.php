   ...
   <h1>Cetak Laporan Peminjaman</h1>
          ...
          <div class="content-dash-item col-sm-12 col-xs-12 col-md-6 col-lg-6">
           <a href="?page=laporan&aksi=anggota" class="button4 col-sm-12 col-xs-12" style="margin-bottom: 1px"><i class="material-icons ">book</i> Laporan Anggota<hr></a>
          </div>
          <div class="content-dash-item col-sm-12 col-xs-12 col-md-6 col-lg-6">
           <a href="?page=laporan&aksi=buku" class="button4 col-sm-12 col-xs-12" style="margin-bottom: 1px"><i class="material-icons ">book</i> Laporan Buku<hr></a>
          </div>

...
<body>
  <div id="mySidenav" class="sidenav tab">
    ...
    <a href="peminjaman.php">             <i class="material-icons">unarchive</i> Peminjaman</a>
    <a href="pengembalian.php">           <i class="material-icons">archive</i> Pengembalian</a>
    <a class="active" href="laporan.php"> <i class="material-icons">perm_device_information</i> Laporan</a>
    <!-- menu sidenav end -->
  </div>
